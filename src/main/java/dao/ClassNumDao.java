...
public class ClassNumDao extends Dao {
	public ClassNum get(String class_num, School school) throws Exception {
		...
		try {
			...
			statement = connection.prepareStatement("select * from student where class_num = ? and school_cd = ?");
	...
	public List<String> filter(School school) throws Exception {
		...
		try {
			...
			statement = connection
					.prepareStatement("select DISTINCT class_num from student where school_cd=? order by class_num");
