...
public class TestDao extends Dao {
    ...
    /**
     * ResultSetからTestリストを生成する（クラス図ではprivate）
     */
    private List<Test> postFilter(ResultSet rSet, School school) throws Exception {
        ...
        while (rSet.next()) {
            ...
            test.setSubject(null); // filter時は一旦nullでも、Action側でセットすればOK
            test.setNo(rSet.getInt("test_no")); // SQL上のエイリアスを使用
    ...
    /**
     * 1件の成績データを保存（UPDATE/INSERT）する（クラス図ではprivate）
     */
