    ...
    <div class="row g-3 align-items-end">
        ...
        <div class="col-md-2">
            ...
            <select name="f1" class="form-select">
                <option value="">--------</option>
                <c:forEach var="y" items="${ent_year_set}"> <%-- 変数名を修正 --%>
        ...
        <div class="col-md-2">
            ...
            <select name="f2" class="form-select">
                <option value="">--------</option>
                <c:forEach var="c" items="${class_num_set}"> <%-- 変数名を修正 --%>
        ...
        <div class="col-md-3">
            ...
            <select name="f3" class="form-select">
                <option value="">--------</option>
                <c:forEach var="s" items="${subjects}"> <%-- 変数名を修正 --%>
...
<form action="TestRegistExecute.action" method="post" class="px-4">
    ...
    <p>科目：${subject.name}（${f4}回）</p> <%-- 何を登録中か表示 --%>
